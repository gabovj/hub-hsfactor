...
export default function ActivatePage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setError("El enlace de invitación es inválido o ya expiró")
    } finally {
      setLoading(false)
    }
  }
    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          <p className="text-xs font-semibold tracking-widest text-[#FE5915] uppercase mb-2">HS Factor</p>
          <h1 className="text-2xl font-bold">Activa tu cuenta</h1>
          <p className="text-sm text-white/40 mt-1">
            Crea tu contraseña para empezar a usar el Hub.
          </p>
        </div>
